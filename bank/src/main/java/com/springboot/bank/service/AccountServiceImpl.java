...
public class AccountServiceImpl implements AccountService {
	...
	final Logger LOGGER = Logger.getLogger(AccountServiceImpl.class);
	...
	public Account createAccount(WrapperBankCustomerAccount wrapperBankCustomerAccount) throws BankException {
		...
		Optional<Bank> bankList = null;
		Optional<Customer> customerList = null;
		...
		if (account == null)
			...
			try {
				//bankList = bankDao.findByBankId(bankId);
			}
			...
			try {
				customerList = customerDao.findByCustomerId(customerId);
			}
			catch(Exception exception) {
				LOGGER.error(exception);
			}
